...
class ProShell(QMainWindow):
    ...
    def _connect_engine(self):
        ...
        self._tracer.started.connect(self._on_trace_started, qc)
        self._tracer.hop_found.connect(self._on_hop, qc)
        self._tracer.finished.connect(self._on_finished, qc)
        self._tracer.error_occurred.connect(self._on_trace_error, qc)
        self._tracer.probing.connect(self._on_probing, qc)
        self._tracer.cancelled.connect(self._on_cancelled, qc)
